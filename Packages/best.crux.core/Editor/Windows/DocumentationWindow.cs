    ...
    public class DocumentationWindow : EditorWindow
    {
        ...
        private static DocumentationWindow GetWindow()
        {
            ...
            var texture =
                AssetDatabase.LoadAssetAtPath<Texture2D>(
                    "Packages/best.crux.core/Icons/Window Icons/Documentation Window.png");
        ...
        private void CreateGUI()
        {
            var uxml = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                "Packages/best.crux.core/UI/Windows/Documentation.uxml");
        ...
        private void ShowRoot()
        {
            ...
            var docButton =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                    "Packages/best.crux.core/UI/Templates/DocSet Entry.uxml");
